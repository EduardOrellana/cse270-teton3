...
class TestSomkeTest():
  ...
  def test_adminPage(self):
    self.driver.get("https://eduardorellana.github.io/cse270-teton3/index.html")
    self.driver.set_window_size(1470, 919)
    self.driver.find_element(By.LINK_TEXT, "Admin").click()
    elements = self.driver.find_elements(By.ID, "username")
    assert len(elements) > 0
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("eduardo")
    self.driver.find_element(By.ID, "password").send_keys("eduardo")
  ...
  def test_joinPage(self):
    ...
    self.driver.find_element(By.NAME, "lname").send_keys("Orellana")
    self.driver.find_element(By.NAME, "bizname").send_keys("LDS")
    self.driver.find_element(By.NAME, "biztitle").send_keys("Analyst")
